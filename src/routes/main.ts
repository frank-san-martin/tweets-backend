...
mainRouter.get('/tweet/:id/answers', verifyJWT, tweetController.getAnswers); // resposta de um determinado tweet
mainRouter.post('/tweet/:id/like', verifyJWT, tweetController.likeToggle); // TOGO: se tem like, tira. Se não tem coloca
...
mainRouter.get('/search', verifyJWT, searchController.searchTweet);
